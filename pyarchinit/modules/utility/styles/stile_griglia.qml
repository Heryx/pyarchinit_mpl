...
<qgis version="1.8.0-Lisboa" minimumScale="0" maximumScale="1e+08" hasScaleBasedVisibilityFlag="0">
    ...
    <symbols>
      <symbol outputUnit="MM" alpha="1" type="marker" name="0">
        ...
        <layer pass="0" class="SvgMarker" locked="0">
          ...
          <prop k="name" v="/north_arrows/NorthArrow2.svg"/>
          <prop k="offset" v="0.1,-3"/>
  ...
  <customproperties>
    ...
    <property key="labeling/fieldName" value="'P'||gid"/>
  ...
  <label>1</label>
  <labelfield>id_punto</labelfield>
  <labelattributes>
    <label fieldname="id_punto" text="Etichetta"/>
    ...
    <x fieldname=""/>
    <y fieldname=""/>
    <offset x="0" y="-4" units="pt" yfieldname="" xfieldname=""/>
  ...
  <edittypes>
    ...
    <edittype type="0" name="def_punto"/>
    <edittype type="0" name="gid"/>
    <edittype type="0" name="id_punto"/>
    <edittype type="0" name="quota"/>
    <edittype type="0" name="sito"/>
    <edittype type="0" name="unita_misura_quota"/>
  </edittypes>
  <editform></editform>
