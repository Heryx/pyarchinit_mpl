...
<qgis version="1.7.0-Wroclaw" minimumScale="0" maximumScale="1e+08" hasScaleBasedVisibilityFlag="0">
  ...
  <renderer-v2 attr="classi_eta" symbollevels="0" type="categorizedSymbol">
    <categories>
      <category symbol="0" value="Adolescente (15-19)" label="Adolescente (15-19)"/>
      <category symbol="1" value="Adulto di eta' avanzata(40-49)" label="Adulto di eta' avanzata(40-49)"/>
      <category symbol="2" value="Adulto di eta' senile (>50)" label="Adulto di eta' senile (>50)"/>
      <category symbol="3" value="Adulto giovane (20-29)" label="Adulto giovane (20-29)"/>
      <category symbol="4" value="Adulto maturo (30-39)" label="Adulto maturo (30-39)"/>
      <category symbol="5" value="Bambino (5-9)" label="Bambino (5-9)"/>
      <category symbol="6" value="Indeterminato" label="Indeterminato"/>
      <category symbol="7" value="Infante (0-4)" label="Infante (0-4)"/>
      <category symbol="8" value="Preadolescente (10-14)" label="Preadolescente (10-14)"/>
    </categories>
    <symbols>
      <symbol outputUnit="MM" alpha="1" type="marker" name="0">
        <layer pass="0" class="SimpleMarker" locked="0">
          <prop k="angle" v="0"/>
          <prop k="color" v="170,5,16,255"/>
      ...
      <symbol outputUnit="MM" alpha="1" type="marker" name="5">
        <layer pass="0" class="SimpleMarker" locked="0">
          <prop k="angle" v="0"/>
          <prop k="color" v="158,255,251,255"/>
          <prop k="color_border" v="255,0,0,255"/>
          <prop k="name" v="circle"/>
          <prop k="offset" v="0,0"/>
          <prop k="size" v="3.33333"/>
